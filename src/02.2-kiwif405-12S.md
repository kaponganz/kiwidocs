...
KIWI F405 supports servo-based camera gimbals. Connect pitch/yaw servos to AUX PWM outputs (PWM5–PWM8).

> CADDX protocol gimbals are not supported on F405 (requires H743 with flash > 1024KB).
