...
<nav class="quick-nav">
  ...
  <a href="#sd-card-version">SD Card</a>
  ...
  <a href="#default-frame-and-modes">Frame & Modes</a>
  <a href="#pinout-reference">Pinout</a>
</nav>
...
|---|---|---|---|
| ArduPilot 4.6 | 4.6.3-dev (e4a1d2cc) | 2026-06-26 | [KiwiH743.zip](download/KiwiH743.zip) |
| ArduPilot 4.5 | TBD | TBD | TBD (`KiwiH743-4.5.zip`) |
| ArduPilot 4.6 (SD card) | 4.6.3-dev (e4a1d2cc) | 2026-06-26 | [KiwiH743-sdcard.zip](download/KiwiH743-sdcard.zip) |
| Betaflight | 2025.12.5-alpha | 2026-06-20 | [BF-2025.12.5-alpha.hex](download/battle_flight/betaflight_2025.12.5-alpha_STM32H743_KAPONGA_KIWIH743.hex) |
| Betaflight | 2025.12.6-kiwi | 2026-07-15 | [BF-2025.12.6-kiwi.hex](download/battle_flight/betaflight_2025.12.6-kiwi_STM32H743_KAPONGA_KIWIH743.hex) |
...
| Firmware | Version | Updated | Download |
|---|---|---|---|
| ArduPilot 4.6 | 4.6.3-dev (71f48db8) | 2026-06-16 | [KiwiH743-2026-06-16.zip](download/old/KiwiH743-2026-06-16.zip) |
| ArduPilot 4.6 (SD card) | 4.6.3-dev (71f48db8) | 2026-06-16 | [KiwiH743-sdcard-2026-06-16.zip](download/old/KiwiH743-sdcard-2026-06-16.zip) |
...
Download and install [KiwiH743-sdcard.zip](download/KiwiH743-sdcard.zip). This firmware disables the onboard DataFlash and enables FATFS file system on the SD card. All logging will go to the SD card instead.
...
<img src="kiwi-743-fpv-sdcard.webp" width="600">
...
| Port   | ArduPilot | Default Protocol       | Pins (TX, RX) | DMA RX        | DMA TX            | Notes                                          |
|--------|-----------|------------------------|---------------|---------------|-------------------|------------------------------------------------|
| USB    | SERIAL0   | MAVLink                | PA11, PA12    | —             | —                 | OTG1 Full Speed                                |
| USART1 | SERIAL1   | ESC Telemetry (115200) | —, PA10       | NODMA         | n/a               | RX only; reserved for ESC telemetry            |
| USART2 | SERIAL2   | SmartAudio (115200)    | PD5, PD6      | NODMA         | NODMA             | Don't use for high baud                        |
| USART3 | SERIAL3   | —                      | PD8, PD9      | NODMA         | DMA               | OK up to ~115 k                                |
| UART4  | SERIAL4   | —                      | PD1, PD0      | DMA exclusive | DMA exclusive     | ★ Rank 1 high-baud — first choice              |
| UART5  | SERIAL5   | MAVLink1 (57600)       | PB6, PD2      | NODMA         | DMA               | OK up to ~115 k                                |
| UART7  | SERIAL7   | MAVLink2               | PE8, PE7      | DMA exclusive | DMA shared (TIM16)| ★ Rank 2 high-baud; RTS PE9, CTS PE10          |
| UART8  | SERIAL8   | RC Input               | PE1, PE0      | NODMA         | DMA               | SBUS/DSM; OK up to ~115 k                      |
...
| Rank | Serial  | UART  | Pins (TX, RX) | Notes                                              |
|------|---------|-------|---------------|----------------------------------------------------|
| 1    | SERIAL4 | UART4 | PD1, PD0      | First choice for any high-baud peripheral          |
| 2    | SERIAL7 | UART7 | PE8, PE7      | Second choice. RTS/CTS wired — tie peripheral CTS to GND, or set `BRD_SER7_RTSCTS = 0` |
